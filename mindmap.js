...
function selectNode(e){
	...
	document.getElementById("nom").innerHTML = currentSkill.name;
	document.forms["skill"].x.value = currentRect.getAttr("x");
	document.forms["skill"].y.value = currentRect.getAttr("y");
